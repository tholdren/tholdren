...
### Tools -
- HTML, CSS, JavaScript
- Adobe Creative Suite (Photoshop, Illustrator, XD, inDesign etc.)
- Figma, Wordpress
- GitHub

## Current Goals 📌
- Level up my front-end development skills  
- Build a portfolio of design-to-code projects  
- Collaborate on creative, user-centered web interfaces
...
[🔗 LinkedIn](https://www.linkedin.com/in/tristan-holdren-43178525a/) | [🌐 Portfolio (Coming Soon)]() | [🖊️ CodePen](https://codepen.io/tholdren)
